...
<div style = "position:fixed;top:0%;height:6%;left:0%;width:99.8%;background-color:rgb(214, 214, 214);border:solid 1px blue;"><!-- Header  -->
    ...
    <img src = "../Only_USE_THIS_THEME/doggoWEBKIT.png" style = "display:inline;float:left;width:auto;height:100%;">

    <a href = "index.php"><button class = "headerBut">Home</button></a> <!-- fill in your url to the page -->

    <img src = "../Only_USE_THIS_THEME/kittyWEBKIT.jpg" style = "display:inline;float:left;width:auto;height:100%;">

    <a href = "contactUs.php"><button class = "headerBut">Contact Us</button></a> <!-- fill in your url to the page -->

    <img src = "../Only_USE_THIS_THEME/iguanaWEBKIT.png" style = "display:inline;;float:left;width:auto;height:100%;">

    <a href = "TrendingPetNames.php"><button class = "headerBut">Trending</button></a> <!-- fill in your url to the page -->

    <img src = "../Only_USE_THIS_THEME/fishWEBKIT.png" style = "display:inline;;float:left;width:auto;height:100%;">
...
<div id = "centerQuiz">
    <h3 id = "centerPageHeader"></h3>  <!-- Page Heading Here -->
...
<div class="main">
	<div class='box1'>
		<h2 #top>Take the pet name quiz!</h2>
